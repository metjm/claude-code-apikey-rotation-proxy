...
Environment:
  ...
  FIRST_CHUNK_TIMEOUT_MS   Max time to wait for the first SSE chunk before retrying (default: 45000)
  FIRST_CHUNK_TIMEOUT_MS_CONTEXT_1M   Same, but for requests carrying the context-1m beta (default: 120000)
